...
Cơ chế khắc chế:
- Kéo vs Búa: Kéo được tăng sát thương (theo cấp, mạnh ở đầu game, yếu dần về cuối game)
- Búa vs Bao: Búa được tăng giáp (theo cấp, yếu ở đầu game, mạnh dần về cuối game)
- Bao vs Kéo: Bao được tăng HP và luck (theo cấp, trung bình ở toàn bộ giai đoạn)
...
Được phép tham khảo thông tin từ v4.1 (chỉ tham khảo, không sao chép).