...
const COUNTER = {
    // Búa vs Kéo: Búa (counter) được +def
    rock_vs_scissors_def: {
        1: 0, 5: 0,
        10: 6, 15: 12, 20: 20, 25: 30, 30: 45, 35: 60, 40: 80
    },
    // Kéo vs Bao: Kéo (counter) được +dmg%
    scissors_vs_paper_dmg: {
        1: 0.10, 5: 0.10,
        10: 0.15, 15: 0.15, 20: 0.15, 25: 0.15, 30: 0.18, 35: 0.20, 40: 0.25
    },
    // Bao vs Búa: Bao (counter) được +HP
    paper_vs_rock_hp: {
        1: 5, 5: 10,
        10: 20, 15: 35, 20: 55, 25: 80, 30: 110, 35: 150, 40: 200
    },
    // Bao vs Búa: Bao (counter) được +luck
    paper_vs_rock_luck: {
        1: 2, 5: 3,
...
const MIRROR = {
    ...
    scissors_dmg_mult: {
        1: 0.80, 5: 0.75,
        10: 0.70, 15: 0.62, 20: 0.55, 25: 0.52, 30: 0.50, 35: 0.48, 40: 0.46
    },
    // Búa vs Búa: giảm def%
    rock_def_mult: {
        1: 0.85, 5: 0.80,
        10: 0.75, 15: 0.68, 20: 0.62, 25: 0.55, 30: 0.50, 35: 0.45, 40: 0.40
    },
    // Bao vs Bao: giảm nhẹ toàn bộ chỉ số
    paper_all_mult: {
        1: 0.92, 5: 0.90,
        10: 0.88, 15: 0.85, 20: 0.82, 25: 0.80, 30: 0.78, 35: 0.76, 40: 0.74
    }
};
